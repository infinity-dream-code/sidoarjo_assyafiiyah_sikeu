...
@section('style')
    ...
    <style>
        .upload-tagihan-toolbar { background: #f8f9fb; }
        .upload-tagihan-toolbar .form-label { margin-bottom: 0.4rem; font-size: 0.8125rem; font-weight: 600; color: #566a7f; }
        .upload-tagihan-toolbar .select2-container { width: 100% !important; }
        .upload-tagihan-bta { display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 0.65rem; padding: 0.35rem 0.65rem; border-radius: 0.375rem; background: #fff; border: 1px dashed #d9dee3; font-size: 0.8125rem; color: #697a8d; }
        .upload-tagihan-bta .badge { font-size: 0.8125rem; letter-spacing: 0.04em; }
        #main_table_wrapper .dataTables_length, #main_table_wrapper .dataTables_filter { padding: 0.75rem 1.25rem 0; }
        #main_table_wrapper .dataTables_info, #main_table_wrapper .dataTables_paginate { padding: 0.75rem 1.25rem 1rem; }
    </style>
@endsection
@section('content')
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Import Data Tagihan PMB</h5>
                    ...
                    <div class="modal-body">
                        <ul class="list-group list-group-timeline mb-3">
                            ...
                            <li class="list-group-item list-group-timeline-danger">Kolom yang harus terisi: <span class="fw-bold">NODAFTAR, NOMINAL</span>.</li>
                            <li class="list-group-item list-group-timeline-danger">Contoh file yang dapat diproses untuk import:
                                <a class="btn btn-sm btn-outline-primary fw-bolder"
                                   href="{{asset('contoh_excel/NURHIDAYAH - TEMPLATE MENU UPLOAD TAGIHAN PMB.xls')}}">

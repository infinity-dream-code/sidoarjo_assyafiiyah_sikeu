...
@section('script')
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Import Data WA</h5>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".mainForm").forEach(form => {
                form.addEventListener("submit", function (e) {
                    ...
                    if (formId === "formImport") {
                        loadingAlert('Meng-unggah data WA');
                        url = '{{route('admin.master-data.setting-data-wa.store')}}';
                        method = 'POST';
                    }else if (formId === "formValidate"){
                        loadingAlert('Menyimpan data WA');
                        url = '{{route('admin.master-data.setting-data-wa.validate-data')}}';
                        method = 'POST';
                    }
            ...
            document.getElementById('btn-clear-data').addEventListener('click', function (e) {
                e.preventDefault();
                loadingAlert(`Membersihkan data yang sudah diimport ......`);

                let url = '{{route('admin.master-data.setting-data-wa.clear-data')}}';
